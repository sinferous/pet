...
// Angry eyebrows overlays
const leftEyebrowAngry = `<path d="M 108 173 L 130 184" stroke="#ff3b30" stroke-width="3" stroke-linecap="round" />`;
const rightEyebrowAngry = `<path d="M 192 173 L 170 184" stroke="#ff3b30" stroke-width="3" stroke-linecap="round" />`;

// Angry mouth overlay
const mouthAngry = `<path d="M 140 205 Q 150 197, 160 205" stroke="#ff3b30" stroke-width="3.5" fill="none" stroke-linecap="round" />`;

// Anger mark (💢) overlay
const angerMark = `
  <g transform="translate(85, 155)">
    <path d="M 0 6 C 5 6, 12 12, 12 18" stroke="#ff3b30" stroke-width="2.5" fill="none" stroke-linecap="round" />
    <path d="M 6 0 C 6 5, 12 12, 18 12" stroke="#ff3b30" stroke-width="2.5" fill="none" stroke-linecap="round" />
    <path d="M 12 0 C 12 5, 6 12, 0 12" stroke="#ff3b30" stroke-width="2.5" fill="none" stroke-linecap="round" />
    <path d="M 18 6 C 13 6, 6 12, 6 18" stroke="#ff3b30" stroke-width="2.5" fill="none" stroke-linecap="round" />
  </g>
`;
...
const framesConfig = {
  ...
  'anger/0': {
    ...
    transform: '',
    tailAngle: 12,
    overlays: leftEyeCover + rightEyeCover + leftEyeClosed + rightEyeClosed + leftEyebrowAngry + rightEyebrowAngry + mouthCover + mouthAngry + angerMark
  },
  'anger/1': {
    mainTransform: 'translate(0, -4)',
    transform: '',
    tailAngle: -12,
    overlays: leftEyeCover + rightEyeCover + leftEyeHappy + rightEyeHappy + leftEyebrowAngry + rightEyebrowAngry + mouthCover + mouthAngry + angerMark
  },
